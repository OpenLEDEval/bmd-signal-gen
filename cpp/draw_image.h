...
/*
 * Draw Image Functions for Blackmagic DeckLink API
 * 
 * This header defines functions for drawing/filling frame buffers with various
 * types of image data. These functions handle the creation of image data and
 * then use the pixel packing functions to convert it to the required format.
 * 
 * INPUT RANGES:
