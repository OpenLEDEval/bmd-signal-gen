...
def create_solid_color_frame(width: int, height: int, rgb_color: Tuple[int, int, int]) -> np.ndarray:
...
def display_color_test(device: BMDDeckLink, pixel_format: PixelFormatType, 
                      rgb_color: Tuple[int, int, int], duration: float = 2.0) -> None:
...
def test_equivalent_gray_levels():
    ...
    try:
        ...
        display_color_test(device, PixelFormatType.FORMAT_10BIT_RGB, (512, 512, 512), 3.0)
        
        # Test R12L 50% gray (2048 out of 4095)
        print("\nTesting R12L 50% gray...")
        display_color_test(device, PixelFormatType.FORMAT_12BIT_RGBLE, (2048, 2048, 2048), 3.0)
        
        # Test R210 25% gray (256 out of 1023)
        print("\nTesting R210 25% gray...")
        display_color_test(device, PixelFormatType.FORMAT_10BIT_RGB, (256, 256, 256), 3.0)
        
        # Test R12L 25% gray (1024 out of 4095)
        print("\nTesting R12L 25% gray...")
        display_color_test(device, PixelFormatType.FORMAT_12BIT_RGBLE, (1024, 1024, 1024), 3.0)
